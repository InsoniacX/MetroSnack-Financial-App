...
# =========================================================================
# PENGAMBILAN BALARAJA CRUD (/pengambilan-kas/balaraja)
# =========================================================================
def get_pengambilan_balaraja(
    ...
    **kwargs,
    ...
    """
    Mengambil data pengambilan kas balaraja dari backend REST API.
    ...
    if cabang_id is not None:
        ...
        try:
            resp = api_get("/pengambilan-kas/balaraja", params=params)
            if resp:
    ...
    for r in raw_rows:
        ...
        items.append({
            ...
            "keterangan": ket or "",
            "lokasi_gudang": ket or "Gudang Balaraja",  # alias for backward compat
...
def add_pengambilan_balaraja(
    ...
    **kwargs,
    ...
    resp = api_post("/pengambilan-kas/balaraja", json_body=body)
...
def update_pengambilan_balaraja(
    ...
    **kwargs,
    ...
    """Mengubah catatan pengambilan kas balaraja."""
    body = {
        "tanggal": _iso(tanggal),
        "keterangan": str(keterangan).strip(),
        "nominal": float(nominal),
    }
    api_put(f"/pengambilan-kas/balaraja/{entry_id}", json_body=body)
    return True


def delete_pengambilan_balaraja(entry_id):
    """Menghapus catatan pengambilan kas balaraja."""
    api_delete(f"/pengambilan-kas/balaraja/{entry_id}")
    return True


def get_akumulasi_bulanan_balaraja(bulan=None, tahun=None, cabang_id=None):
    """Mengembalikan rekap total biaya pengambilan balaraja pada bulan/tahun tertentu."""
    items = get_pengambilan_balaraja(cabang_id=cabang_id, bulan=bulan, tahun=tahun)
