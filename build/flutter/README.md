...
* `metrosnack_v1` - project identifier (lowercase, no spaces, i.e. "snake_case") used for bundle IDs and package names.
* `` - project description.
* `MetroSnack_v1` - executable or bundle name on disk.
* `MetroSnack_v1` - display name shown in window titles and about app dialogs.
