...
* `metrosnack` - project identifier (lowercase, no spaces, i.e. "snake_case") used for bundle IDs and package names.
* `` - project description.
* `MetroSnack` - executable or bundle name on disk.
* `MetroSnack` - display name shown in window titles and about app dialogs.
